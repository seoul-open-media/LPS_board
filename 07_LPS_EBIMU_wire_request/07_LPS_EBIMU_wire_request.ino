...
#define POLL_ACK_CHECK_THRESHOLD 8 //8
// serial message flag
...
volatile float vec[VEC_MAX] = {0,   0,   0,     0,        0,      0};
char sbuf[SBUF_SIZE];
...
void setup() {
  ...
  // DEBUG monitoring
  Serial.begin(57600);
  softSerial.begin(9600); // Set the baudrate with GTKTERM <lf> <sb1>
  delay(2000);
